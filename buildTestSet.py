...
#Predict tracks for a playlist given its title and the first 50 tracks
#Predict tracks for a playlist given its title and 50 random tracks
...
#Predict tracks for a playlist given its title and the first 200 tracks
#Predict tracks for a playlist given its title and 200 random tracks

# Save file
df_playlists_challenge.to_hdf('data/df_data/df_playlists_challenge.hdf', key='abc')
df_tracks_challenge.to_hdf('data/df_data/df_tracks_challenge.hdf', key='abc')
df_tracks_challenge_incomplete.to_hdf('data/df_data/df_tracks_challenge_incomplete.hdf', key='abc')
